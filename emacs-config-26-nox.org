...
Completion using [[https://www.masteringemacs.org/article/introduction-to-ido-mode][Ido]] mode extended with [[https://github.com/DarwinAwardWinner/ido-completing-read-plus][ido-completing-read+]].

#+name: ido-minibuffer-completion
#+begin_src emacs-lisp
...
Use ~whiteboard~ built-in color theme.
